...
enum
{
  lbot_arm_interfaces__srv__GetFrame_Event__request__MAX_SIZE = 1
};
// response
enum
{
  lbot_arm_interfaces__srv__GetFrame_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/GetFrame in the package lbot_arm_interfaces.
typedef struct lbot_arm_interfaces__srv__GetFrame_Event
{
  service_msgs__msg__ServiceEventInfo info;
  lbot_arm_interfaces__srv__GetFrame_Request__Sequence request;
  lbot_arm_interfaces__srv__GetFrame_Response__Sequence response;
} lbot_arm_interfaces__srv__GetFrame_Event;

// Struct for a sequence of lbot_arm_interfaces__srv__GetFrame_Event.
typedef struct lbot_arm_interfaces__srv__GetFrame_Event__Sequence
{
