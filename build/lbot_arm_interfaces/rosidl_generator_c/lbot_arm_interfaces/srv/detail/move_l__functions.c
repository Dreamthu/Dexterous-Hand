...
lbot_arm_interfaces__srv__MoveL_Request__create(void)
{
...
lbot_arm_interfaces__srv__MoveL_Request__Sequence__init(lbot_arm_interfaces__srv__MoveL_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(lbot_arm_interfaces__srv__MoveL_Request)) {
      return false;
    }
  ...
  lbot_arm_interfaces__srv__MoveL_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(lbot_arm_interfaces__srv__MoveL_Request)) {
      return false;
    }
...
lbot_arm_interfaces__srv__MoveL_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
lbot_arm_interfaces__srv__MoveL_Response__Sequence__init(lbot_arm_interfaces__srv__MoveL_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(lbot_arm_interfaces__srv__MoveL_Response)) {
      return false;
    }
  ...
  lbot_arm_interfaces__srv__MoveL_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(lbot_arm_interfaces__srv__MoveL_Response)) {
      return false;
    }
    const size_t allocation_size =
...
bool
lbot_arm_interfaces__srv__MoveL_Event__init(lbot_arm_interfaces__srv__MoveL_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    lbot_arm_interfaces__srv__MoveL_Event__fini(msg);
    return false;
  }
  // request
  if (!lbot_arm_interfaces__srv__MoveL_Request__Sequence__init(&msg->request, 0)) {
    lbot_arm_interfaces__srv__MoveL_Event__fini(msg);
    return false;
  }
  // response
  if (!lbot_arm_interfaces__srv__MoveL_Response__Sequence__init(&msg->response, 0)) {
    lbot_arm_interfaces__srv__MoveL_Event__fini(msg);
    return false;
  }
  return true;
...
void
lbot_arm_interfaces__srv__MoveL_Event__fini(lbot_arm_interfaces__srv__MoveL_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  lbot_arm_interfaces__srv__MoveL_Request__Sequence__fini(&msg->request);
  // response
  lbot_arm_interfaces__srv__MoveL_Response__Sequence__fini(&msg->response);
}

bool
lbot_arm_interfaces__srv__MoveL_Event__are_equal(const lbot_arm_interfaces__srv__MoveL_Event * lhs, const lbot_arm_interfaces__srv__MoveL_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!lbot_arm_interfaces__srv__MoveL_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!lbot_arm_interfaces__srv__MoveL_Response__Sequence__are_equal(
...
bool
lbot_arm_interfaces__srv__MoveL_Event__copy(
  const lbot_arm_interfaces__srv__MoveL_Event * input,
  lbot_arm_interfaces__srv__MoveL_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!lbot_arm_interfaces__srv__MoveL_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!lbot_arm_interfaces__srv__MoveL_Response__Sequence__copy(
...
lbot_arm_interfaces__srv__MoveL_Event *
lbot_arm_interfaces__srv__MoveL_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lbot_arm_interfaces__srv__MoveL_Event * msg = (lbot_arm_interfaces__srv__MoveL_Event *)allocator.allocate(sizeof(lbot_arm_interfaces__srv__MoveL_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(lbot_arm_interfaces__srv__MoveL_Event));
  bool success = lbot_arm_interfaces__srv__MoveL_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
lbot_arm_interfaces__srv__MoveL_Event__destroy(lbot_arm_interfaces__srv__MoveL_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    lbot_arm_interfaces__srv__MoveL_Event__fini(msg);
...
bool
lbot_arm_interfaces__srv__MoveL_Event__Sequence__init(lbot_arm_interfaces__srv__MoveL_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lbot_arm_interfaces__srv__MoveL_Event * data = NULL;

  if (size) {
    if (size > SIZE_MAX / sizeof(lbot_arm_interfaces__srv__MoveL_Event)) {
      return false;
    }
    data = (lbot_arm_interfaces__srv__MoveL_Event *)allocator.zero_allocate(size, sizeof(lbot_arm_interfaces__srv__MoveL_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = lbot_arm_interfaces__srv__MoveL_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        lbot_arm_interfaces__srv__MoveL_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
lbot_arm_interfaces__srv__MoveL_Event__Sequence__fini(lbot_arm_interfaces__srv__MoveL_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      lbot_arm_interfaces__srv__MoveL_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
lbot_arm_interfaces__srv__MoveL_Event__Sequence *
lbot_arm_interfaces__srv__MoveL_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lbot_arm_interfaces__srv__MoveL_Event__Sequence * array = (lbot_arm_interfaces__srv__MoveL_Event__Sequence *)allocator.allocate(sizeof(lbot_arm_interfaces__srv__MoveL_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = lbot_arm_interfaces__srv__MoveL_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
lbot_arm_interfaces__srv__MoveL_Event__Sequence__destroy(lbot_arm_interfaces__srv__MoveL_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    lbot_arm_interfaces__srv__MoveL_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
lbot_arm_interfaces__srv__MoveL_Event__Sequence__are_equal(const lbot_arm_interfaces__srv__MoveL_Event__Sequence * lhs, const lbot_arm_interfaces__srv__MoveL_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!lbot_arm_interfaces__srv__MoveL_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
lbot_arm_interfaces__srv__MoveL_Event__Sequence__copy(
  const lbot_arm_interfaces__srv__MoveL_Event__Sequence * input,
  lbot_arm_interfaces__srv__MoveL_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(lbot_arm_interfaces__srv__MoveL_Event)) {
      return false;
    }
    const size_t allocation_size =
      input->size * sizeof(lbot_arm_interfaces__srv__MoveL_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    lbot_arm_interfaces__srv__MoveL_Event * data =
      (lbot_arm_interfaces__srv__MoveL_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lbot_arm_interfaces__srv__MoveL_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          lbot_arm_interfaces__srv__MoveL_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!lbot_arm_interfaces__srv__MoveL_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
