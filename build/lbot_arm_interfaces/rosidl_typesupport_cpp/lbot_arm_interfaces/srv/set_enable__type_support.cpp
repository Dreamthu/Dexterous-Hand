...
static const _SetEnable_Request_type_support_symbol_names_t _SetEnable_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lbot_arm_interfaces, srv, SetEnable_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lbot_arm_interfaces, srv, SetEnable_Request)),
  }
};
...
{
  return &::lbot_arm_interfaces::srv::rosidl_typesupport_cpp::SetEnable_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lbot_arm_interfaces, srv, SetEnable_Request)() {
  return get_message_type_support_handle<lbot_arm_interfaces::srv::SetEnable_Request>();
}
...
static const _SetEnable_Response_type_support_symbol_names_t _SetEnable_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lbot_arm_interfaces, srv, SetEnable_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lbot_arm_interfaces, srv, SetEnable_Response)),
  }
};
...
{
  return &::lbot_arm_interfaces::srv::rosidl_typesupport_cpp::SetEnable_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lbot_arm_interfaces, srv, SetEnable_Response)() {
  return get_message_type_support_handle<lbot_arm_interfaces::srv::SetEnable_Response>();
}
...
typedef struct _SetEnable_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _SetEnable_Event_type_support_ids_t;

static const _SetEnable_Event_type_support_ids_t _SetEnable_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_cpp",  // ::rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
    "rosidl_typesupport_introspection_cpp",  // ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  }
...
typedef struct _SetEnable_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _SetEnable_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _SetEnable_Event_type_support_symbol_names_t _SetEnable_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lbot_arm_interfaces, srv, SetEnable_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lbot_arm_interfaces, srv, SetEnable_Event)),
  }
};

typedef struct _SetEnable_Event_type_support_data_t
{
  void * data[2];
} _SetEnable_Event_type_support_data_t;

static _SetEnable_Event_type_support_data_t _SetEnable_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _SetEnable_Event_message_typesupport_map = {
  2,
  "lbot_arm_interfaces",
  &_SetEnable_Event_message_typesupport_ids.typesupport_identifier[0],
  &_SetEnable_Event_message_typesupport_symbol_names.symbol_name[0],
  &_SetEnable_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t SetEnable_Event_message_type_support_handle = {
  ::rosidl_typesupport_cpp::typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_SetEnable_Event_message_typesupport_map),
  ::rosidl_typesupport_cpp::get_message_typesupport_handle_function,
...
{
  return &::lbot_arm_interfaces::srv::rosidl_typesupport_cpp::SetEnable_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lbot_arm_interfaces, srv, SetEnable_Event)() {
  return get_message_type_support_handle<lbot_arm_interfaces::srv::SetEnable_Event>();
}
...
static const _SetEnable_type_support_symbol_names_t _SetEnable_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lbot_arm_interfaces, srv, SetEnable)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lbot_arm_interfaces, srv, SetEnable)),
  }
};
...
static const rosidl_service_type_support_t SetEnable_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<lbot_arm_interfaces::srv::SetEnable_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<lbot_arm_interfaces::srv::SetEnable_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<lbot_arm_interfaces::srv::SetEnable_Event>(),
...
{
  return &::lbot_arm_interfaces::srv::rosidl_typesupport_cpp::SetEnable_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, lbot_arm_interfaces, srv, SetEnable)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<lbot_arm_interfaces::srv::SetEnable>();
}
