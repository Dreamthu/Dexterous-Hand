...
class Metaclass_MoveJ_Event(type):
    """Metaclass of message 'MoveJ_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__move_j__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__move_j__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__move_j__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__move_j__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__move_j__event
...
class MoveJ_Event(metaclass=Metaclass_MoveJ_Event):
    """Message class 'MoveJ_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<lbot_arm_interfaces/MoveJ_Request, 1>',
        'response': 'sequence<lbot_arm_interfaces/MoveJ_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['lbot_arm_interfaces', 'srv'], 'MoveJ_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['lbot_arm_interfaces', 'srv'], 'MoveJ_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from lbot_arm_interfaces.srv import MoveJ_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, MoveJ_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'MoveJ_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from lbot_arm_interfaces.srv import MoveJ_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, MoveJ_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'MoveJ_Response'"
...
class Metaclass_MoveJ(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _move_j.Metaclass_MoveJ_Event._TYPE_SUPPORT is None:
                _move_j.Metaclass_MoveJ_Event.__import_type_support__()
...
class MoveJ(metaclass=Metaclass_MoveJ):
    ...
    from lbot_arm_interfaces.srv._move_j import MoveJ_Event as Event
