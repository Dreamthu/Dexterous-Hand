...
class Metaclass_ForwardKinematics_Event(type):
    """Metaclass of message 'ForwardKinematics_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__forward_kinematics__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__forward_kinematics__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__forward_kinematics__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__forward_kinematics__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__forward_kinematics__event
...
class ForwardKinematics_Event(metaclass=Metaclass_ForwardKinematics_Event):
    """Message class 'ForwardKinematics_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<lbot_arm_interfaces/ForwardKinematics_Request, 1>',
        'response': 'sequence<lbot_arm_interfaces/ForwardKinematics_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['lbot_arm_interfaces', 'srv'], 'ForwardKinematics_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['lbot_arm_interfaces', 'srv'], 'ForwardKinematics_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from lbot_arm_interfaces.srv import ForwardKinematics_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ForwardKinematics_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'ForwardKinematics_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from lbot_arm_interfaces.srv import ForwardKinematics_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ForwardKinematics_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'ForwardKinematics_Response'"
...
class Metaclass_ForwardKinematics(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _forward_kinematics.Metaclass_ForwardKinematics_Event._TYPE_SUPPORT is None:
                _forward_kinematics.Metaclass_ForwardKinematics_Event.__import_type_support__()
...
class ForwardKinematics(metaclass=Metaclass_ForwardKinematics):
    ...
    from lbot_arm_interfaces.srv._forward_kinematics import ForwardKinematics_Event as Event
