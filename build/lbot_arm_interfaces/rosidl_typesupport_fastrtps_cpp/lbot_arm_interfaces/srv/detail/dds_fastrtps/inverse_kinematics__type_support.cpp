...
#include "lbot_arm_interfaces/srv/detail/inverse_kinematics__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const lbot_arm_interfaces::srv::InverseKinematics_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  lbot_arm_interfaces::srv::InverseKinematics_Request & ros_message)
{
  // Member: joints
  {
    cdr >> ros_message.joints;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lbot_arm_interfaces::srv::InverseKinematics_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const lbot_arm_interfaces::srv::InverseKinematics_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lbot_arm_interfaces::srv::InverseKinematics_Request *>(
    untyped_ros_message);
...
{
  return &lbot_arm_interfaces::srv::typesupport_fastrtps_cpp::_InverseKinematics_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lbot_arm_interfaces, srv, InverseKinematics_Request)() {
  return &lbot_arm_interfaces::srv::typesupport_fastrtps_cpp::_InverseKinematics_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_lbot_arm_interfaces
cdr_serialize(
  const lbot_arm_interfaces::srv::InverseKinematics_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: joints
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  lbot_arm_interfaces::srv::InverseKinematics_Response & ros_message)
{
  // Member: joints
  {
    cdr >> ros_message.joints;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = lbot_arm_interfaces::srv::InverseKinematics_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const lbot_arm_interfaces::srv::InverseKinematics_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<lbot_arm_interfaces::srv::InverseKinematics_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &lbot_arm_interfaces::srv::typesupport_fastrtps_cpp::_InverseKinematics_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lbot_arm_interfaces, srv, InverseKinematics_Response)() {
  return &lbot_arm_interfaces::srv::typesupport_fastrtps_cpp::_InverseKinematics_Response__handle;
}
...
// functions for lbot_arm_interfaces::srv::InverseKinematics_Request already declared above

// functions for lbot_arm_interfaces::srv::InverseKinematics_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_lbot_arm_interfaces
cdr_serialize(
  const lbot_arm_interfaces::srv::InverseKinematics_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  lbot_arm_interfaces::srv::InverseKinematics_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        lbot_arm_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_InverseKinematics_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        lbot_arm_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_InverseKinematics_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = lbot_arm_interfaces::srv::InverseKinematics_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        lbot_arm_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_InverseKinematics_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        lbot_arm_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_InverseKinematics_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const lbot_arm_interfaces::srv::InverseKinematics_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<lbot_arm_interfaces::srv::InverseKinematics_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_lbot_arm_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<lbot_arm_interfaces::srv::InverseKinematics_Event>()
{
  return &lbot_arm_interfaces::srv::typesupport_fastrtps_cpp::_InverseKinematics_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lbot_arm_interfaces, srv, InverseKinematics_Event)() {
  return &lbot_arm_interfaces::srv::typesupport_fastrtps_cpp::_InverseKinematics_Event__handle;
}
...
static const rosidl_service_type_support_t _InverseKinematics__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<lbot_arm_interfaces::srv::InverseKinematics_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<lbot_arm_interfaces::srv::InverseKinematics_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<lbot_arm_interfaces::srv::InverseKinematics_Event>(),
  &::rosidl_typesupport_cpp::service_create_event_message<lbot_arm_interfaces::srv::InverseKinematics>,
  &::rosidl_typesupport_cpp::service_destroy_event_message<lbot_arm_interfaces::srv::InverseKinematics>,
...
{
  return &lbot_arm_interfaces::srv::typesupport_fastrtps_cpp::_InverseKinematics__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lbot_arm_interfaces, srv, InverseKinematics)() {
  return &lbot_arm_interfaces::srv::typesupport_fastrtps_cpp::_InverseKinematics__handle;
}
