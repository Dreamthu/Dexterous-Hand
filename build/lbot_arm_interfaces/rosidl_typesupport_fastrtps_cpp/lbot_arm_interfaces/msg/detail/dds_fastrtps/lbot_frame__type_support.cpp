...
#include "lbot_arm_interfaces/msg/detail/lbot_frame__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const lbot_arm_interfaces::msg::LbotFrame & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  lbot_arm_interfaces::msg::LbotFrame & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lbot_arm_interfaces::msg::LbotFrame;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const lbot_arm_interfaces::msg::LbotFrame *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lbot_arm_interfaces::msg::LbotFrame *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LbotFrame__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const lbot_arm_interfaces::msg::LbotFrame *>(
...
static size_t _LbotFrame__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_LbotFrame(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _LbotFrame__callbacks = {
...
static rosidl_message_type_support_t _LbotFrame__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LbotFrame__callbacks,
...
{
  return &lbot_arm_interfaces::msg::typesupport_fastrtps_cpp::_LbotFrame__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lbot_arm_interfaces, msg, LbotFrame)() {
  return &lbot_arm_interfaces::msg::typesupport_fastrtps_cpp::_LbotFrame__handle;
}
