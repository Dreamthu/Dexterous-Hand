...
#include "lbot_arm_interfaces/msg/detail/arm_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const lbot_arm_interfaces::msg::ArmState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  lbot_arm_interfaces::msg::ArmState & ros_message)
{
  // Member: joints
  {
    cdr >> ros_message.joints;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lbot_arm_interfaces::msg::ArmState;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_lbot_arm_interfaces
max_serialized_size_key_ArmState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const lbot_arm_interfaces::msg::ArmState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lbot_arm_interfaces::msg::ArmState *>(
    untyped_ros_message);
...
{
  return &lbot_arm_interfaces::msg::typesupport_fastrtps_cpp::_ArmState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lbot_arm_interfaces, msg, ArmState)() {
  return &lbot_arm_interfaces::msg::typesupport_fastrtps_cpp::_ArmState__handle;
}
