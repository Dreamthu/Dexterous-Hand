...
{
public:
  explicit Init_SetZero_Event_response(::lbot_arm_interfaces::srv::SetZero_Event & msg)
  : msg_(msg)
  {}
  ::lbot_arm_interfaces::srv::SetZero_Event response(::lbot_arm_interfaces::srv::SetZero_Event::_response_type arg)
  {
...
private:
  ::lbot_arm_interfaces::srv::SetZero_Event msg_;
};

class Init_SetZero_Event_request
{
public:
  explicit Init_SetZero_Event_request(::lbot_arm_interfaces::srv::SetZero_Event & msg)
  : msg_(msg)
  {}
  Init_SetZero_Event_response request(::lbot_arm_interfaces::srv::SetZero_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetZero_Event_request info(::lbot_arm_interfaces::srv::SetZero_Event::_info_type arg)
  {
...
template<>
inline
auto build<::lbot_arm_interfaces::srv::SetZero_Event>()
{
  return lbot_arm_interfaces::srv::builder::Init_SetZero_Event_info();
}
