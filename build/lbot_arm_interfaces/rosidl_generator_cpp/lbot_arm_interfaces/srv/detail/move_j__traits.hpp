...
[[deprecated("use lbot_arm_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const lbot_arm_interfaces::srv::MoveJ_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  lbot_arm_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use lbot_arm_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const lbot_arm_interfaces::srv::MoveJ_Event & msg)
{
  return lbot_arm_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<lbot_arm_interfaces::srv::MoveJ_Event>()
{
  return "lbot_arm_interfaces::srv::MoveJ_Event";
}

template<>
inline const char * name<lbot_arm_interfaces::srv::MoveJ_Event>()
{
  return "lbot_arm_interfaces/srv/MoveJ_Event";
}

template<>
struct has_fixed_size<lbot_arm_interfaces::srv::MoveJ_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<lbot_arm_interfaces::srv::MoveJ_Event>
  : std::integral_constant<bool, has_bounded_size<lbot_arm_interfaces::srv::MoveJ_Request>::value && has_bounded_size<lbot_arm_interfaces::srv::MoveJ_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<lbot_arm_interfaces::srv::MoveJ_Event>
  : std::true_type {};
