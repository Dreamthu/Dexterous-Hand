...
static const _MoveL_Event_type_support_symbol_names_t _MoveL_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lbot_arm_interfaces, srv, MoveL_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lbot_arm_interfaces, srv, MoveL_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, lbot_arm_interfaces, srv, MoveL_Event)() {
  return &::lbot_arm_interfaces::srv::rosidl_typesupport_c::MoveL_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t MoveL_service_type_support_handle = {
  ...
  &MoveL_Request_message_type_support_handle,
  &MoveL_Response_message_type_support_handle,
  &MoveL_Event_message_type_support_handle,
