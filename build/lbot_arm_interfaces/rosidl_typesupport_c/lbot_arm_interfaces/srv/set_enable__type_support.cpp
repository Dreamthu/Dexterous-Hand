...
static const _SetEnable_Event_type_support_symbol_names_t _SetEnable_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lbot_arm_interfaces, srv, SetEnable_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lbot_arm_interfaces, srv, SetEnable_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, lbot_arm_interfaces, srv, SetEnable_Event)() {
  return &::lbot_arm_interfaces::srv::rosidl_typesupport_c::SetEnable_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t SetEnable_service_type_support_handle = {
  ...
  &SetEnable_Request_message_type_support_handle,
  &SetEnable_Response_message_type_support_handle,
  &SetEnable_Event_message_type_support_handle,
