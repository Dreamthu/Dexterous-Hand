...
static const _ChangeFrame_Event_type_support_symbol_names_t _ChangeFrame_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lbot_arm_interfaces, srv, ChangeFrame_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lbot_arm_interfaces, srv, ChangeFrame_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, lbot_arm_interfaces, srv, ChangeFrame_Event)() {
  return &::lbot_arm_interfaces::srv::rosidl_typesupport_c::ChangeFrame_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t ChangeFrame_service_type_support_handle = {
  ...
  &ChangeFrame_Request_message_type_support_handle,
  &ChangeFrame_Response_message_type_support_handle,
  &ChangeFrame_Event_message_type_support_handle,
