...
class InverseKinematics_Event(metaclass=Metaclass_InverseKinematics_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<lbot_arm_interfaces/InverseKinematics_Request, 1>',
        'response': 'sequence<lbot_arm_interfaces/InverseKinematics_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['lbot_arm_interfaces', 'srv'], 'InverseKinematics_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['lbot_arm_interfaces', 'srv'], 'InverseKinematics_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from lbot_arm_interfaces.srv import InverseKinematics_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from lbot_arm_interfaces.srv import InverseKinematics_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class InverseKinematics(metaclass=Metaclass_InverseKinematics):
    ...
    from lbot_arm_interfaces.srv._inverse_kinematics import InverseKinematics_Event as Event
