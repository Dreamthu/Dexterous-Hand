...
class Metaclass_SetFrame_Event(type):
    """Metaclass of message 'SetFrame_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_frame__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_frame__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_frame__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_frame__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_frame__event
...
class SetFrame_Event(metaclass=Metaclass_SetFrame_Event):
    """Message class 'SetFrame_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<lbot_arm_interfaces/SetFrame_Request, 1>',
        'response': 'sequence<lbot_arm_interfaces/SetFrame_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['lbot_arm_interfaces', 'srv'], 'SetFrame_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['lbot_arm_interfaces', 'srv'], 'SetFrame_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from lbot_arm_interfaces.srv import SetFrame_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, SetFrame_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetFrame_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from lbot_arm_interfaces.srv import SetFrame_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetFrame_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetFrame_Response'"
...
class Metaclass_SetFrame(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _set_frame.Metaclass_SetFrame_Event._TYPE_SUPPORT is None:
                _set_frame.Metaclass_SetFrame_Event.__import_type_support__()
...
class SetFrame(metaclass=Metaclass_SetFrame):
    ...
    from lbot_arm_interfaces.srv._set_frame import SetFrame_Event as Event
