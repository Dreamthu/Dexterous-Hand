...
inline std::string to_yaml(const MoveC_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use lbot_arm_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const lbot_arm_interfaces::srv::MoveC_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  lbot_arm_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use lbot_arm_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const lbot_arm_interfaces::srv::MoveC_Event & msg)
{
  return lbot_arm_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<lbot_arm_interfaces::srv::MoveC_Event>()
{
  return "lbot_arm_interfaces::srv::MoveC_Event";
}

template<>
inline const char * name<lbot_arm_interfaces::srv::MoveC_Event>()
{
  return "lbot_arm_interfaces/srv/MoveC_Event";
}

template<>
struct has_fixed_size<lbot_arm_interfaces::srv::MoveC_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<lbot_arm_interfaces::srv::MoveC_Event>
  : std::integral_constant<bool, has_bounded_size<lbot_arm_interfaces::srv::MoveC_Request>::value && has_bounded_size<lbot_arm_interfaces::srv::MoveC_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<lbot_arm_interfaces::srv::MoveC_Event>
  : std::true_type {};
